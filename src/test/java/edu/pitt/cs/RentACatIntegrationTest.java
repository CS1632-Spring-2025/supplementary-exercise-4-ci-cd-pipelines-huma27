...
public class RentACatIntegrationTest {
    ...
    public void testGetCatNullNumCats0() {
        ...
        try {
            ...
            // Call the private method with id = 2
            Cat result = (Cat) getCatMethod.invoke(r, 2);

            // Verify the return value is null
            assertNull("Return value should be null when no cats exist.", result);

            // Verify the system output is "Invalid cat ID." + newline
            assertEquals("Invalid cat ID." + System.lineSeparator(), outContent.toString());

        } catch (Exception e) {
            // Handle any reflection-related exceptions
            fail("Exception occurred while invoking getCat method: " + e.getMessage());
        } finally {
    ...
    public void testListCatsNumCats0() {
        ...
        assertEquals("", emptyRentACat.listCats());
    }
    ...
    public void testListCatsNumCats3() {
        // TODO: Fill in
        assertEquals("ID 1. Jennyanydots" + newline + "ID 2. Old Deuteronomy" + newline + "ID 3. Mistoffelees", r.listCats().trim());
    ...
    public void testRenameFailureNumCats0() {
        ...
        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outContent));
        assertFalse(emptyRentACat.renameCat(2, "Garfield"));
        assertEquals("Invalid cat ID." + newline, outContent.toString());
        System.setOut(System.out);
    ...
    public void testRentCatFailureNumCats3() {
        ...
        assertFalse(r.rentCat(2));  //fail because already rented 
        assertTrue(c2.getRented());  // c2 should still be rented
