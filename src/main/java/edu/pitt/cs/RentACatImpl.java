...
public class RentACatImpl implements RentACat {
    ...
    public boolean returnCat(int id) {
        ...
        for (Cat cat : cats) {
            if (cat.getId() == id) {
                if (cat.getRented()) {
                    cat.returnCat(); // Mark the cat as returned
        ...
        // If the loop completes without finding the cat, print "Invalid cat ID."
    ...
    public String listCats() {
        ...
        for (Cat cat : cats) {
            if (!cat.getRented()) { // Only include cats that are not rented
